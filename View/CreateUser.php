<form action="/action_page.php">
  <table style="width: 100%;">
    <tbody>
      <tr>
        <td style="width: 50.0000%; font-size: 24px;"><label for="fname">Navn:</label></td>
        <td style="width: 50.0000%; font-size: 24px;"><input type="text" id="fname" name="fname" value="John"></td>
      </tr>
      <tr>
        <td style="width: 50.0000%; font-size: 24px;"><label for="lname">Efternavn:</label></td>
